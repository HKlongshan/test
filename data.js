const siteData = {
    president: {
        name: "何文熙先生",
        title: "僑港順德龍山同鄉會會長",
        message: "尊敬的各位鄉親：\n\n過去一年，承蒙各位鄉親信任與支持，本會各項會務蓬勃發展。在新的一年裡，我仝人將繼續秉持創會宗旨，團結鄉親、服務鄉親、造福鄉親，攜手弘揚龍山文化，促進家鄉與香港的繁榮發展。\n\n期盼廣大鄉親一如既往支持本會，共創美好未來。\n\n敬祝\n各位鄉親身體健康、萬事如意！\n\n僑港順德龍山同鄉會會長 何文熙\n2026年5月"
    },
    news: [
        {
            id: 1,
    ...
    contact: {
        address: "香港九龍旺角洗衣街62-72號3樓A室",
        phone: "(852) 2388-XXXX",
        email: "info@longshan.xin",
        wechat: "longshan_hk"
    }
};
